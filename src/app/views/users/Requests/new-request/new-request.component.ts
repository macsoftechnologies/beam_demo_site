...
private groupByModule(data: any[], displayProperty: string): any[] {
  ...
  Getselectedflooritem(event) {
    ...
    if (this.selectedbuilding == '13') {
      ...
      switch (event) {
        case "B1 Ground Floor":
          this.planType = "B1 Ground Floor";
          this.pdfSrc = "assets/images/plans/Building1/building_level_1.pdf";
          this.blocks = [
            { name: "Building1 Ground Floor Zones", pdfSrc: "assets/images/plans/Building1/building_level_1.pdf", className: 'ba-zone-1', planType: 'B1 Ground Floor' },

          ]
          break;
          case "B1 First Floor":
          this.planType = "B1 First Floor";
          this.pdfSrc = "assets/images/plans/Building1/building_level_2.pdf";
          this.blocks = [
            { name: "Building1 First Floor Zones", pdfSrc: "assets/images/plans/Building1/building_level_2.pdf", className: 'ba-zone-1', planType: 'B1 First Floor' },
      ...
      switch (event) {
        case "B2 Ground Floor":
          this.planType = "B2 Ground Floor";
          this.pdfSrc = "assets/images/plans/Building2/building2_level_1.pdf";
          this.blocks = [
            { name: "Building2 Ground Floor Zones", pdfSrc: "assets/images/plans/Building2/building2_level_1.pdf", className: 'ba-zone-2', planType: 'B2 Ground Floor' },

          ]
          break;
          case "B2 First Floor":
          this.planType = "B2 First Floor";
          this.pdfSrc = "assets/images/plans/Building2/building2_level_2.pdf";
          this.blocks = [
            { name: "Building2 First Floor Zones", pdfSrc: "assets/images/plans/Building2/building2_level_2.pdf", className: 'ba-zone-2', planType: 'B2 First Floor' },
